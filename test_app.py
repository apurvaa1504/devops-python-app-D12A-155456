...
task = create_task("Implement login API", "Develop authentication endpoint", "High")
assert task["title"] == "Implement login API"
assert task["priority"] == "High"
assert task["status"] == "Pending"

def test_update_task_status():
task = create_task("Fix database issue", "Resolve connection timeout", "Medium")
...
create_task("Test task", "Testing invalid priority", "Critical")
